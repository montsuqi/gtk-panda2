...
main (int argc, char *argv[])
{
  ...
  g_signal_connect(
    gtk_panda_combo_get_entry(GTK_PANDA_COMBO(combo1)), "activate",
    G_CALLBACK(on_combo_entry1_activate), NULL);
  g_signal_connect(
    gtk_panda_combo_get_entry(GTK_PANDA_COMBO(combo1)), "changed",
  ...
  g_signal_connect(
    gtk_panda_combo_get_entry(GTK_PANDA_COMBO(combo2)), "activate",
    G_CALLBACK(on_combo_entry2_activate), NULL);
  g_signal_connect(
    gtk_panda_combo_get_entry(GTK_PANDA_COMBO(combo2)), "changed",
