...
extern GtkType gtk_panda_entry_get_type (void);
extern GtkWidget* gtk_panda_entry_new (void);
extern void gtk_panda_entry_set_input_mode (GtkPandaEntry *entry, enum gtk_panda_entry_input_mode mode);
extern void gtk_panda_entry_set_xim_enabled (GtkPandaEntry *entry, gboolean flag);
