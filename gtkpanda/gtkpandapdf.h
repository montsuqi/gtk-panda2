...
#define GTK_IS_PANDA_PDF_CLASS(klass)	(G_TYPE_CHECK_CLASS_TYPE ((klass), GTK_PANDA_TYPE_PDF))
...
int gtk_panda_pdf_get_page_count(GtkPandaPDF *pps);
void gtk_panda_pdf_print(GtkPandaPDF *pps,gboolean showdialog);
